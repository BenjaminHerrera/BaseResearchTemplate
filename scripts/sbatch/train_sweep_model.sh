...
read -p "Where should the slurm output be (default is /scratch/%u/projects/<PROJECT_NAME>/slurm_dump/train_sweep_model_%j/): " parition_type
slurm_output=${slurm_output:-/scratch/%u/projects/<PROJECT_NAME>/slurm_dump/train_sweep_model_%j/}
...
#SBATCH --job-name="<PROJECT_NAME> // TRAIN SWEEP - $execution_config"                      # job name
