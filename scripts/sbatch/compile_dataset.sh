...
read -p "Where should the slurm output be (default is /scratch/%u/projects/<PROJECT_NAME>/slurm_dump/compile_dataset_%j/): " parition_type
slurm_output=${slurm_output:-/scratch/%u/projects/<PROJECT_NAME>/slurm_dump/compile_dataset_%j/}
...
#SBATCH --job-name="<PROJECT_NAME> // Compile Dataset - $execution_config"                  # job name
