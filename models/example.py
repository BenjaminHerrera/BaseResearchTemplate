...
class ExampleModel(nn.Module):
    """Model definition for a multi-layer perceptron"""
    ...
    def __init__(
        ...
        """Constructor method for the multi-layer perceptron model
    ...
    def forward(self: "ExampleModel", x: torch.Tensor) -> torch.Tensor:
        ...
        for i in range(len(self.layers) - 1):
            # Initially pass the inputs to the linear layers
            x = self.layers[i](x)
